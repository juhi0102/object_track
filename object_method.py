...
drone_controller.drone.rcPitch = 0
drone_controller.drone.rcRoll = 0
drone_controller.drone.rcThrottle = 0
drone_controller.drone.rcYaw = 0
...
while True:
    ...
    # Flight control based on object tracking
    if dir == 1:
        drone_controller.drone.left = 50  # Adjust roll to make the drone move left
    elif dir == 2:
        drone_controller.drone.right =50  # Adjust roll to make the drone move right
    elif dir == 3:
        drone_controller.drone.forward()  # Adjust pitch to make the drone move forward
    elif dir == 4:
        drone_controller.drone.land()  # Adjust throttle to make the drone move down
    else:
